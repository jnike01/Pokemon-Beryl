...
const u8 gText_MainMenuMysteryGift[] = _("Mystery Gif");
...
const u8 gText_DefaultNameDarren[] = _("Darry");
...
const u8 gText_DefaultNameAllie[] = _("Allia");
...
const u8 gText_TreasuresPocket[] = _("Power Ups");
...
const u8 gText_ThrowInPremierBall[] = _("I'll throw in a Premiere Ball, too.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_Treasures[] = _("Power Ups");
...
const u8 gText_BirthIsland[] = _("Birch Island");
...
const u8 gText_PokedexDiploma[] = _("P;ayer: {CLEAR 0x10}{COLOR RED}{SHADOW LIGHT_RED}{PLAYER}{COLOR DARK_GRAY}{SHADOW LIGHT_GRAY}\n\nThis document certifies\nthat you have successfully\ncompleted your\n{STR_VAR_1} Pokédex.\n\n{CLEAR_TO 0x42}{COLOR RED}{SHADOW LIGHT_RED}Game Freak");
...
const u8 gEasyChatGroupName_Greetings[] = _("Greeting");
...
const u8 gText_NormanMatchCallName[] = _("Dag");
