...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM56_TRI_ATTACK] =
    {
        .name = _("TM56"),
        .itemId = ITEM_TM56_TRI_ATTACK,
        .price = 3000,
    ...
    [ITEM_TM58_BRUTAL_SWING] =
    {
        .name = _("TM58"),
        .itemId = ITEM_TM58_BRUTAL_SWING,
        .price = 3000,
    ...
    [ITEM_TM59_WILL_O_WISP] =
    {
        .name = _("TM59"),
        .itemId = ITEM_TM59_WILL_O_WISP,
        .price = 3000,
    ...
    [ITEM_TM60_ACROBATICS] =
    {
        .name = _("TM60"),
        .itemId = ITEM_TM60_ACROBATICS,
        .price = 3000,
    ...
    [ITEM_TM62_SHADOW_CLAW] =
    {
        .name = _("TM62"),
        .itemId = ITEM_TM62_SHADOW_CLAW,
        .price = 3000,
    ...
    [ITEM_TM64_SMART_STRIKE] =
    {
        .name = _("TM64"),
        .itemId = ITEM_TM64_SMART_STRIKE,
        .price = 3000,
